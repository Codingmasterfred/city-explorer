...
function GetLocationData() {
    ...
    let FetchData = async (event) => {
        ...
        let response = await axios.get(`https://us1.locationiq.com/v1/search?key=pk.858228159b59b411fc2826e2fbfea459&q=${Change}&format=json`)
        ...
        <div>
            <Form>
                <Form.Group className="mb-3" controlId="formBasicEmail">
                    ...
                    <Form.Control onChange={onchange} type="text" placeholder="Type A Location" />
